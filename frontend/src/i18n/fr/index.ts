export default {
  ...
  tutorialTitle: "Bienvenue dans l'interface d'annotation de jeux de données !",
  tutorialSteps: [
    'Cliquez ici pour obtenir une nouvelle image à annoter.',
    'Cliquez ici ou appuyez sur la touche [N] pour ajouter une nouvelle annotation.',
    ...
    "Cliquez ici pour afficher une carte de référence. Assurez-vous de l'orienter correctement.",
