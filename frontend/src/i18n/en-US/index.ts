export default {
  ...
  userTimeSpent: 'Time Spent',
  timeSpentMinutes: '{minutes}min',
  timeSpentHours: '{hours}h',
  timeSpentDays: '{days}d.',
  never: 'Never',
  ...
  retryingAddAnnotation: 'Retrying to add annotation...',
  failedToUpdateAnnotation: 'Failed to update annotation',
  retryingUpdateAnnotation: 'Retrying to update annotation...',
  failedToDeleteAnnotation: 'Failed to delete annotation',
  retryingDeleteAnnotation: 'Retrying to delete annotation...',
